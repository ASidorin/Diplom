...
public class DataSql {
    ...
    public final static String urlForPostgres = "jdbc:postgresql://localhost:5432/testDB";
    public final static String  userForPostgres = "postgres";
    public final static String  passwordForPostgres = "postgres";


    public static String getPaymentStatus() {
        val getStatus = "SELECT status FROM payment_entity ORDER BY created DESC LIMIT 1;";
        try (
                val connect = DriverManager.getConnection(urlForMysql, userForMysql, passwordForMysql);
